...
import kotlinx.android.synthetic.main.fragment_add_new_natural_person.check
import kotlinx.android.synthetic.main.fragment_add_new_natural_person.cta
...
import kotlinx.android.synthetic.main.fragment_add_new_natural_person.li_dialog
import kotlinx.android.synthetic.main.fragment_add_new_natural_person.root
...
class AddNewNaturalPersonFragment : BaseFragment<AddNewNaturalPersonViewModel>(),
    ...
    override fun initUi() {
        ...
        dob.setOnClickListener {
            viewModel.onDateClicked(it, naturalPersonDetails?.dateOfBirth?.let { it1 -> dateToMilis(it1) })
        }

        expdate.setOnClickListener {
            viewModel.onDateClicked(it, naturalPersonDetails?.identityDocument?.expirationDate?.let { it1 -> dateToMilis(it1) })
        }
